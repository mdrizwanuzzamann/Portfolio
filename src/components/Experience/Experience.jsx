...
import { FaCss3, FaFigma, FaHtml5, FaJs, FaNode, FaNodeJs, FaReact } from "react-icons/fa";
  ...
  return (
    <div id="Experience" className="p-10 md:p-24">
      ...
      <div className="flex flex-wrap items-center justify-around">
        ...
        {/* ------------------------------ */}
        <div>
          <div className="flex gap-10 bg-slate-950 bg-45 mt-4 rounded-lg p-4 items-center ">
            <FaGoogle color="#4285f4" size={50} />
            <span className="text-white">
              <h2 className="leading-tight">Software Engineer, Google</h2>
              <p className="text-sm leading-tight font-thin">Sept 2023 - Present</p>
              <ul className="text-sm p-2">
                <li>- Work as software </li>
